...
namespace ProjectCCS.Controllers
{
    public class HomeController : Controller
    {
        ...
        public void SendMail(IEnumerable<ShoppingCart> list, int IdBill)
        {
            ...
            mail.From = new MailAddress("ducloi1244@gmail.com");
            mail.To.Add(getUser());
            ...
            smtpClient.Port = 587;
            smtpClient.Credentials = new System.Net.NetworkCredential("ducloi1244@gmail.com", "qbieabalexoihgzg");
        ...
        public ActionResult Filter(int id , int? page)
        {
            ...
            int pageNumber = (page ?? 1);
            int pageSize = 3;
            return View("ListProduct", context.Products.Where(p => p.categoryId.Equals(id)).ToList().ToPagedList(pageNumber, pageSize));
            //ViewBag.categories = context.Categories.ToList();
